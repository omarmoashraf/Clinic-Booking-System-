  ...
  const actions = [
    {
      ...
      title: t("doctors.manageAvailability"),
      description: t("doctors.manageAvailabilityDesc"),
      icon: Clock,
      iconBg: "bg-primary/10 text-primary",
    },
    {
      href: "/doctor/appointments",
      title: t("doctors.allAppointments"),
      description: t("doctors.allAppointmentsDesc"),
      icon: Calendar,
      iconBg: "bg-secondary text-secondary-foreground",
    },
    {
      href: "/doctor/profile",
      title: t("doctors.editProfile"),
      description: t("doctors.editProfileDesc"),
      icon: User,
