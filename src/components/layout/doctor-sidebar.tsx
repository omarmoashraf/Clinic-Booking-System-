...
/**
 * Persistent Desktop Sidebar for Doctor Portal
 */
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between overflow-y-auto px-3 py-4 space-y-6">
        <nav className="space-y-1" aria-label={t("doctors.menu")}>
          ...
          >
            ...
            <div className="min-w-0 flex-1 text-start">
              ...
              <div className="flex items-center gap-1 mt-0.5">
                <Badge
                  variant="outline"
                  className="text-[10px] px-1 py-0 h-4 font-normal text-muted-foreground truncate max-w-[120px]"
                >
                  {specialtyLabel}
                </Badge>
              </div>
